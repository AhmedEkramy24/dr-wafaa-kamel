      ...
      <div className="max-w-6xl mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div>
          ...
          <p className="text-sm leading-relaxed">
            أستاذة اللغويات بجامعة القاهرة، وعضو مجمعي اللغة العربية بالقاهرة
            ودمشق. تسعى لنشر الوعي اللغوي والثقافي في الوطن العربي.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>
              <Link to="/cv" className="hover:underline hover:text-gray-200">
                السيرة الذاتية
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link to="/books" className="hover:underline hover:text-gray-200">
                الكتب والدراسات
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <div className="flex items-center gap-4 text-2xl">
            <Link to="mailto:example@email.com" aria-label="Email">
